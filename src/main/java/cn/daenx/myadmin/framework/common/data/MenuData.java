...
import cn.daenx.myadmin.framework.common.utils.MyMenuUtil;
...
public class MenuData {
    ...
    public MyMenuVo demoPeople() {
        MyMenuVo vo = MyMenuUtil.GenMenu("人员管理", "/demoPeople", "peoples", "demoPeople/index");
        return vo;
    }

    public MyMenuVo systemConfig() {
        MyMenuVo vo = MyMenuUtil.GenMenu("系统设置", "/systemConfig", "system", "systemConfig/index");
        return vo;
    }

    public MyMenuVo testMenu() {
        MyMenuVo vo = MyMenuUtil.GenCatalog("测试菜单", "/testMenu", "system");
        vo.addChildren(MyMenuUtil.GenMenu("菜单1", "/a1", "peoples", "demoPeople/index"));
        vo.addChildren(MyMenuUtil.GenMenu("菜单2", "/a2", "peoples", "demoPeople/index"));
        ...
        vo.addChildren(MyMenuUtil.GenCatalog("多级菜单", "/more", "peoples")
                .addChildren(MyMenuUtil.GenMenu("多级1", "/b1", "peoples", "demoPeople/index"))
                .addChildren(MyMenuUtil.GenMenu("多级2", "/b2", "peoples", "demoPeople/index"))
        );
        return vo;
    }
